...
import com.ct.movie.SeatActivity;

public class MovieScheduleAdapter extends BaseExpandableListAdapter {
	...
	public MovieScheduleAdapter(Context context, List<String> group,
			...
			for (int i = 0; i < verticaLinearLayouts.length; i++) {
				...
				for (int j = 0; j < 6; j++) {
					...
					LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
							0, LayoutParams.WRAP_CONTENT, 0.1f);
					...
					button.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							if (((Button) v).getText().toString().trim() != "") {
